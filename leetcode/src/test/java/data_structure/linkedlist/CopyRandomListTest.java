 ...
 * 注意：与本题相同：<a href="https://leetcode.cn/problems/fu-za-lian-biao-de-fu-zhi-lcof/?envType=study-plan-v2&envId=coding-interviews">剑指 Offer 35. 复杂链表的复制</a>
 *
 * @author xuzhou
 * @since 2023/6/25 10:55
 */
public class CopyRandomListTest {
    ...
    public Node copyRandomList(Node head) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            curr.next = i < list.size() - 1 ? list.get(i + 1) : null;
            if (curr.random != null) {
                curr.random = list.get(map.get(curr.random));
            }
        }
        return list.get(0);
    }
