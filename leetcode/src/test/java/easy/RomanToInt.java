...
//        int startIndex = 0;
//        int res = 0;
//        for (; startIndex < s.length(); ) {
//            Integer left = romanMap.get(s.charAt(startIndex));
//            if (startIndex < s.length() - 1) {
//                Integer right = romanMap.get(s.charAt(startIndex + 1));
//                if (right > left) {
//                    res += right - left;
//                    startIndex += 2;
//                    continue;
...
//            integers[i] = romanToInt(chars[i]);
//        }
//        int res = 0;
//        for (int i = 0; i < integers.length; i++) {
//            if (i < integers.length - 1 && integers[i] < integers[i + 1]) {
//                res += integers[i + 1] - integers[i];
//                i++;
//            } else {
//                res += integers[i];
//            }
...
//    }
    public static int romanToInt(String s) {
        int res = 0;
        int preNum = romanToInt(s.charAt(0));
